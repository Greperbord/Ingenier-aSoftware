...
import 'package:kk/second_page.dart';
import 'package:kk/third_page.dart';
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: [
          BottomNavigationBarItem(
            icon: Icon(Icons.today, color: Color.fromARGB(255, 153, 207, 214), size: 30.0),
            label: "Eventos",
          ),
          BottomNavigationBarItem(
            icon: Icon(Icons.assignment_ind, color: Colors.pinkAccent, size: 30.0),
            label: "Registro"
          ),
          BottomNavigationBarItem(
            icon: Icon(Icons.local_mall, color: Color.fromARGB(255, 193, 241, 173), size: 30.0),
            label: "Ventas",  
          ),
        ],
      ),
